...
RC privateTestCase_6() {
    ...
    std::cout << std::endl << "***** In QE Private Test Case 6 *****" << std::endl;
...
int main() {
    ...
    if (privateTestCase_6() != success) {
        std::cout << "***** [FAIL] QE Private Test Case 6 failed. *****" << std::endl;
        return fail;
    } else {
        std::cout << "***** QE Private Test Case 6 finished. The result will be examined. *****" << std::endl;
        return success;
    }
}
